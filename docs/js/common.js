...
(function ($) {
    ...
    window.initializeProfile = function (profile_name) {
        if (!(profile_name in profiles[profilesKey]))
    ...
    if (!("current" in profiles)) profiles.current = "Default";
        ...
        if ($("#" + id).length === 1) {
            ...
            if (checked) {
                ...
                if (window.current_page_id) {
                    ...
                    const section_idx = parseInt(
                        $(el).attr("data-section-idx"),
                    );
                    window.progress[window.current_page_id]["sections"][
                        section_idx
                    ][0] += 1;
                }
            } else {
